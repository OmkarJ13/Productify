    ...
    return open ? (
      <>
        ...
        {reactDom.createPortal(
          <div className="fixed top-1/2 left-1/2 z-20 flex translate-x-[-50%] translate-y-[-50%] animate-[fade_ease-in-out_250ms] flex-col gap-2 border border-gray-200 bg-white shadow-xl">
            <button
